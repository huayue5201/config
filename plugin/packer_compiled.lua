...
_G.packer_plugins = {
  ...
  coq_nvim = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/huayue520/.local/share/nvim/site/pack/packer/opt/coq_nvim",
  ...
  ["dracula.nvim"] = {
    config = { "\27LJ\2\n\0\0\3\0\6\0\t6\0\0\0009\0\1\0'\1\3\0=\1\2\0006\0\0\0009\0\4\0'\2\5\0B\0\2\1K\0\1\0-\t\t\t\tcolorscheme dracula\n                \bcmd\f#4B0082\29dracula_lualine_bg_color\6g\bvim\0" },
    loaded = true,
  ...
  ["lsp_signature.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/huayue520/.local/share/nvim/site/pack/packer/opt/lsp_signature.nvim",
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "aerial.nvim", "coq_nvim", "null-ls.nvim", "nvim-lightbulb", "lsp_signature.nvim", "nvim-code-action-menu" },
    config = { "\27LJ\2\n5\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\26config.nvim-lspconfig\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/huayue520/.local/share/nvim/site/pack/packer/opt/nvim-lspconfig",
  ...
  sniprun = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/huayue520/.local/share/nvim/site/pack/packer/opt/sniprun",
...
try_loadstring("\27LJ\2\n\0\0\3\0\6\0\t6\0\0\0009\0\1\0'\1\3\0=\1\2\0006\0\0\0009\0\4\0'\2\5\0B\0\2\1K\0\1\0-\t\t\t\tcolorscheme dracula\n                \bcmd\f#4B0082\29dracula_lualine_bg_color\6g\bvim\0", "config", "dracula.nvim")
...
vim.cmd [[noremap <silent> <leader>ru <cmd>lua require("packer.load")({'sniprun'}, { keys = "<lt>leader>ru", prefix = "" }, _G.packer_plugins)<cr>]]
vim.cmd [[noremap <silent> <leader>rc <cmd>lua require("packer.load")({'sniprun'}, { keys = "<lt>leader>rc", prefix = "" }, _G.packer_plugins)<cr>]]
vim.cmd [[noremap <silent> gb <cmd>lua require("packer.load")({'Comment.nvim'}, { keys = "gb", prefix = "" }, _G.packer_plugins)<cr>]]
vim.cmd [[noremap <silent> <leader>rd <cmd>lua require("packer.load")({'sniprun'}, { keys = "<lt>leader>rd", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-dap', 'fidget.nvim', 'aerial.nvim', 'nvim-surround', 'sniprun', 'null-ls.nvim', 'Comment.nvim', 'nvim-lightbulb', 'nvim-ufo', 'lsp_signature.nvim', 'vim-matchup', 'nvim-code-action-menu', 'indent-blankline.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-dap', 'fidget.nvim', 'aerial.nvim', 'nvim-surround', 'sniprun', 'null-ls.nvim', 'Comment.nvim', 'nvim-lightbulb', 'nvim-ufo', 'lsp_signature.nvim', 'vim-matchup', 'nvim-code-action-menu', 'indent-blankline.nvim'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf'}, { ft = "qf" }, _G.packer_plugins)]]
vim.cmd [[au FileType toml ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-dap', 'fidget.nvim', 'aerial.nvim', 'nvim-surround', 'sniprun', 'null-ls.nvim', 'Comment.nvim', 'nvim-lightbulb', 'nvim-ufo', 'lsp_signature.nvim', 'vim-matchup', 'nvim-code-action-menu', 'indent-blankline.nvim'}, { ft = "toml" }, _G.packer_plugins)]]
vim.cmd [[au FileType rust ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-dap', 'fidget.nvim', 'aerial.nvim', 'nvim-surround', 'sniprun', 'null-ls.nvim', 'Comment.nvim', 'nvim-lightbulb', 'nvim-ufo', 'lsp_signature.nvim', 'vim-matchup', 'nvim-code-action-menu', 'indent-blankline.nvim'}, { ft = "rust" }, _G.packer_plugins)]]
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-dap', 'fidget.nvim', 'aerial.nvim', 'nvim-surround', 'sniprun', 'null-ls.nvim', 'Comment.nvim', 'nvim-lightbulb', 'nvim-ufo', 'lsp_signature.nvim', 'vim-matchup', 'nvim-code-action-menu', 'indent-blankline.nvim'}, { ft = "javascript" }, _G.packer_plugins)]]
vim.cmd [[au FileType typescript ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-dap', 'fidget.nvim', 'aerial.nvim', 'nvim-surround', 'sniprun', 'null-ls.nvim', 'Comment.nvim', 'nvim-lightbulb', 'nvim-ufo', 'lsp_signature.nvim', 'vim-matchup', 'nvim-code-action-menu', 'indent-blankline.nvim'}, { ft = "typescript" }, _G.packer_plugins)]]
vim.cmd [[au FileType html ++once lua require("packer.load")({'nvim-lspconfig', 'nvim-dap', 'fidget.nvim', 'aerial.nvim', 'nvim-surround', 'sniprun', 'null-ls.nvim', 'Comment.nvim', 'nvim-lightbulb', 'nvim-ufo', 'lsp_signature.nvim', 'nvim-ts-autotag', 'vim-matchup', 'nvim-code-action-menu', 'indent-blankline.nvim'}, { ft = "html" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-lspconfig', 'coq_nvim', 'nvim-autopairs', 'lsp_signature.nvim', 'vim-matchup'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
