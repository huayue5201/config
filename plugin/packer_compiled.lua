...
vim.cmd [[au FileType html ++once lua require("packer.load")({'fidget.nvim', 'null-ls.nvim', 'nvim-ts-autotag'}, { ft = "html" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'nvim-autopairs', 'tabout.nvim'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
