...
_G.packer_plugins = {
  ...
  ["nvim-pqf.git"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/huayue520/.local/share/nvim/site/pack/packer/opt/nvim-pqf.git",
...
vim.cmd [[au FileType go ++once lua require("packer.load")({'null-ls.nvim', 'nvim-dap', 'nvim-ufo', 'fidget.nvim', 'lsp_signature.nvim', 'nvim-code-action-menu'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType norg ++once lua require("packer.load")({'neorg'}, { ft = "norg" }, _G.packer_plugins)]]
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'null-ls.nvim', 'nvim-dap', 'nvim-ufo', 'fidget.nvim', 'lsp_signature.nvim', 'nvim-code-action-menu'}, { ft = "javascript" }, _G.packer_plugins)]]
vim.cmd [[au FileType typescript ++once lua require("packer.load")({'null-ls.nvim', 'nvim-dap', 'nvim-ufo', 'fidget.nvim', 'lsp_signature.nvim', 'nvim-code-action-menu'}, { ft = "typescript" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'null-ls.nvim', 'nvim-dap', 'nvim-ufo', 'fidget.nvim', 'lsp_signature.nvim', 'nvim-code-action-menu'}, { ft = "lua" }, _G.packer_plugins)]]
vim.cmd [[au FileType toml ++once lua require("packer.load")({'null-ls.nvim', 'nvim-dap', 'nvim-ufo', 'fidget.nvim', 'lsp_signature.nvim', 'nvim-code-action-menu'}, { ft = "toml" }, _G.packer_plugins)]]
vim.cmd [[au FileType rust ++once lua require("packer.load")({'null-ls.nvim', 'nvim-dap', 'nvim-ufo', 'fidget.nvim', 'lsp_signature.nvim', 'nvim-code-action-menu'}, { ft = "rust" }, _G.packer_plugins)]]
vim.cmd [[au FileType qf ++once lua require("packer.load")({'nvim-bqf', 'nvim-pqf.git'}, { ft = "qf" }, _G.packer_plugins)]]
vim.cmd [[au FileType html ++once lua require("packer.load")({'null-ls.nvim', 'nvim-dap', 'nvim-ufo', 'fidget.nvim', 'nvim-ts-autotag', 'lsp_signature.nvim', 'nvim-code-action-menu'}, { ft = "html" }, _G.packer_plugins)]]
