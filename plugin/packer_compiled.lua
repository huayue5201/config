...
_G.packer_plugins = {
  ...
  ["dracula.nvim"] = {
    config = { "\27LJ\2\nL\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0-\t\t\t\tcolorscheme dracula\n                \bcmd\bvim\0" },
    loaded = true,
...
vim.cmd [[au FileType lua ++once lua require("packer.load")({'nvim-surround', 'nvim-dap', 'fidget.nvim', 'nvim-code-action-menu', 'nvim-ufo', 'null-ls.nvim', 'lsp_signature.nvim', 'indent-blankline.nvim', 'sniprun', 'Comment.nvim'}, { ft = "lua" }, _G.packer_plugins)]]
vim.cmd [[au FileType go ++once lua require("packer.load")({'nvim-surround', 'nvim-dap', 'fidget.nvim', 'nvim-code-action-menu', 'nvim-ufo', 'null-ls.nvim', 'lsp_signature.nvim', 'indent-blankline.nvim', 'sniprun', 'Comment.nvim'}, { ft = "go" }, _G.packer_plugins)]]
vim.cmd [[au FileType rust ++once lua require("packer.load")({'nvim-surround', 'nvim-dap', 'fidget.nvim', 'nvim-code-action-menu', 'nvim-ufo', 'null-ls.nvim', 'lsp_signature.nvim', 'indent-blankline.nvim', 'sniprun', 'Comment.nvim'}, { ft = "rust" }, _G.packer_plugins)]]
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'nvim-surround', 'nvim-dap', 'fidget.nvim', 'nvim-code-action-menu', 'nvim-ufo', 'null-ls.nvim', 'lsp_signature.nvim', 'indent-blankline.nvim', 'sniprun', 'Comment.nvim'}, { ft = "javascript" }, _G.packer_plugins)]]
vim.cmd [[au FileType typescript ++once lua require("packer.load")({'nvim-surround', 'nvim-dap', 'fidget.nvim', 'nvim-code-action-menu', 'nvim-ufo', 'null-ls.nvim', 'lsp_signature.nvim', 'indent-blankline.nvim', 'sniprun', 'Comment.nvim'}, { ft = "typescript" }, _G.packer_plugins)]]
vim.cmd [[au FileType html ++once lua require("packer.load")({'nvim-surround', 'nvim-dap', 'fidget.nvim', 'nvim-code-action-menu', 'nvim-ufo', 'null-ls.nvim', 'lsp_signature.nvim', 'nvim-ts-autotag', 'indent-blankline.nvim', 'sniprun', 'Comment.nvim'}, { ft = "html" }, _G.packer_plugins)]]
vim.cmd [[au FileType toml ++once lua require("packer.load")({'nvim-surround', 'nvim-dap', 'fidget.nvim', 'nvim-code-action-menu', 'nvim-ufo', 'null-ls.nvim', 'lsp_signature.nvim', 'indent-blankline.nvim', 'sniprun', 'Comment.nvim'}, { ft = "toml" }, _G.packer_plugins)]]
