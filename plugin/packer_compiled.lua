...
vim.cmd [[au FileType rust ++once lua require("packer.load")({'fidget.nvim', 'lsp_signature.nvim', 'null-ls.nvim', 'nvim-code-action-menu', 'nvim-dap', 'nvim-ufo'}, { ft = "rust" }, _G.packer_plugins)]]
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'fidget.nvim', 'lsp_signature.nvim', 'null-ls.nvim', 'nvim-code-action-menu', 'nvim-dap', 'nvim-ufo'}, { ft = "javascript" }, _G.packer_plugins)]]
vim.cmd [[au FileType typescript ++once lua require("packer.load")({'fidget.nvim', 'lsp_signature.nvim', 'null-ls.nvim', 'nvim-code-action-menu', 'nvim-dap', 'nvim-ufo'}, { ft = "typescript" }, _G.packer_plugins)]]
vim.cmd [[au FileType html ++once lua require("packer.load")({'fidget.nvim', 'lsp_signature.nvim', 'null-ls.nvim', 'nvim-code-action-menu', 'nvim-dap', 'nvim-ts-autotag', 'nvim-ufo'}, { ft = "html" }, _G.packer_plugins)]]
vim.cmd [[au FileType lua ++once lua require("packer.load")({'fidget.nvim', 'lsp_signature.nvim', 'null-ls.nvim', 'nvim-code-action-menu', 'nvim-dap', 'nvim-ufo'}, { ft = "lua" }, _G.packer_plugins)]]
vim.cmd [[au FileType toml ++once lua require("packer.load")({'fidget.nvim', 'lsp_signature.nvim', 'null-ls.nvim', 'nvim-code-action-menu', 'nvim-dap', 'nvim-ufo'}, { ft = "toml" }, _G.packer_plugins)]]
vim.cmd [[au FileType go ++once lua require("packer.load")({'fidget.nvim', 'lsp_signature.nvim', 'null-ls.nvim', 'nvim-code-action-menu', 'nvim-dap', 'nvim-ufo'}, { ft = "go" }, _G.packer_plugins)]]
